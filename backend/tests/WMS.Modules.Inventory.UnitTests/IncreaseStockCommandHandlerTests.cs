...
public class IncreaseStockCommandHandlerTests
{
    ...
    {
        _handler = new IncreaseStockCommandHandler(_stockItemWriteRepository, _stockMovementWriteRepository);
    }
    ...
    public async Task Handle_IncreasesQuantityAndRecordsAMovement()
    {
        ...
        var command = new IncreaseStockCommand(warehouseId, productId, 10m, "Goods receipt approved");
