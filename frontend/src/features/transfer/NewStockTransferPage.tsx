...
import { useCreateStockTransfer } from './api/stockTransfers'
    ...
    <div className="max-w-2xl space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1.5">
          <Label htmlFor="source-warehouse">Kaynak Depo</Label>
          <Select
          ...
          >
            <SelectTrigger id="source-warehouse" className="w-full">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="destination-warehouse">Hedef Depo</Label>
          <Select
            items={warehouseItems}
          ...
          >
            <SelectTrigger id="destination-warehouse" className="w-full">
        ...
        {createStockTransfer.isError && (
          <p className="text-sm text-destructive">
            {getApiErrorMessage(createStockTransfer.error)}
          </p>
        )}
        ...
        <div className="flex gap-2">
          <Button
            type="submit"
            disabled={!isValid || createStockTransfer.isPending}
          >
            {createStockTransfer.isPending ? 'Kaydediliyor...' : 'Kaydet'}
          </Button>
          <Button
            type="button"
            variant="outline"
